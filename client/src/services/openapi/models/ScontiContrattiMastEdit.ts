...
import type { ScontiContrattiDettEdit } from './ScontiContrattiDettEdit';

export type ScontiContrattiMastEdit = {
    dettagli: Array<ScontiContrattiDettEdit>;
    ID: string;
    ...
    dataEsaurimentoPrevista: string | null;
    dataEsaurimentoEffettiva: string | null;
    utdc: string | null;
    utdv: string | null;
};
